  ...
  grid.innerHTML = filtered.map((p) => {
    ...
    <div class="product-card" style="animation: fadeInUp 0.5s ease forwards; display: flex; flex-direction: column; height: 100%;" onclick="openProductDetail(${p.id})">
      ...
      <div class="product-info" style="display: flex; flex-direction: column; flex-grow: 1;">
        ...
        <button class="btn-primary" style="margin-top: auto; width:100%; font-size:10px; padding:10px; display: flex; align-items: center; justify-content: center; gap: 8px;" onclick="event.stopPropagation(); addToCart(${p.id})" ${p.stock === "Out of Stock" ? 'disabled' : ''}>
